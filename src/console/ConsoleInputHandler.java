...
public class ConsoleInputHandler extends InputHandler implements ConsoleHandler {
    ...
    private void onMouseEnteredEvent(MouseEvent e) {
        lastMouseEvent = e;
        onMouseEntered(e);
        updateEnter(e);
    }
    private void onMouseExitedEvent(MouseEvent e) {
        lastMouseEvent = e;
        onMouseExited(e);
        if (enteredComponent != null) {
            enteredComponent.onMouseExited(e);
            enteredComponent = null;
        }
    }
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        //System.out.println("entered " + getEnabledLayerAt(e) + " " + e.getX() + " " + e.getY());
    }
    ...
    public void mouseExited(MouseEvent e) {
        ...
        //System.out.println("exited " + getEnabledLayerAt(e) + " " + e.getX() + " " + e.getY());
    }
