...
public class BufferedImageUtils {
    ...
    public static void drawChar(BufferedImage image, int x, int y, char c, int foregroundColor, int backgroundColor, ConsoleFont consoleFont) {
        drawStringFast(image, x, y, "" + c, foregroundColor, backgroundColor, consoleFont);
    }
    public static void drawString(BufferedImage image, int x, int y, String str, int foregroundColor, int backgroundColor, ConsoleFont consoleFont) {
    ...
    public static void drawStringFast(BufferedImage image, int x, int y, String str, int foregroundColor, int backgroundColor, ConsoleFont consoleFont) {
        final Graphics2D g2 = image.createGraphics();
